...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_PGDN, KC_BSPC, KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_DEL, \
           LOWER,   RAISE, KC_LALT, KC_LGUI,       KC_SPC,         KC_SFTENT,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT           \
  ),
